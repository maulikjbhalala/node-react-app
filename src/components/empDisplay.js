...
import LoadComponent from './dataLoader'
    ...
    render() {
            ...
            return (
                <div className="container">
                      ...
                      <div  className="panel-body">
                <Button variant="outline-success" onClick={this.onClick}>Fetch Data</Button>
                    </div>
                      </div>
                   
                    
            {this.state.loading?<LoadingSpinner/>: <div className="panel panel-default">
